...
function entradaArea_triangulo(){
...
function entradaGalones(){
	var litros=parseInt(prompt("Ingrese cantidad de litros"));
	galones(litros);
}

//Ejercicio #5: Sueldo
function sueldo(valorHora,cantHoras,cantDias){
	...
	if(cantDias<=5){
		...
		alert("Ha excedido la cantidad de horas legales trabajadas")
	}
}
